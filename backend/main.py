...
from api.clients import client_report_router, clients_router
...
from services.watch_folder_scheduler import (
    start_watch_folder_scheduler,
    stop_watch_folder_scheduler,
)
...
async def lifespan(app: FastAPI):
    ...
    # Drive watched folder polling (brief §6.2 volet 2). Off by default —
    # flip SYNTHESE_ENABLE_DRIVE_POLLING=1 once a tenant has connected
    # their Drive + selected a folder.
    start_watch_folder_scheduler()
